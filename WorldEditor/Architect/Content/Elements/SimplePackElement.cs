...
public class SimplePackElement : AbstractPackElement
{
     ...
     * <param name="category">
     *     The category to register the object under (a category will automatically be created if one by
     ...
     */
    public SimplePackElement(GameObject obj, string name, string category, [CanBeNull] Sprite sprite = null,
        int weight = 0) : base(name, category, weight)
    {
        _obj = obj;
        _sprite = sprite;
    }
